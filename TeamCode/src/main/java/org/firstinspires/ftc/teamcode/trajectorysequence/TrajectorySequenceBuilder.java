...
public class TrajectorySequenceBuilder {
    ...
    public TrajectorySequenceBuilder lineTo(Vector2d endPosition) {
        return addPath(() -> currentTrajectoryBuilder.lineTo(endPosition, currentVelConstraint, currentAccelConstraint, currentDecelConstraint));
    }
    ...
    public TrajectorySequenceBuilder lineTo(
        ...
        return addPath(() -> currentTrajectoryBuilder.lineTo(endPosition, velConstraint, accelConstraint, currentDecelConstraint));
    }
    ...
    public TrajectorySequenceBuilder lineTo(
        ...
        return addPath(() -> currentTrajectoryBuilder.lineTo(endPosition, velConstraint, accelConstraint, decelConstraint));
    }

    public TrajectorySequenceBuilder lineToConstantHeading(Vector2d endPosition) {
        return addPath(() -> currentTrajectoryBuilder.lineToConstantHeading(endPosition, currentVelConstraint, currentAccelConstraint, currentDecelConstraint));
    }
    ...
    public TrajectorySequenceBuilder lineToConstantHeading(
        ...
        return addPath(() -> currentTrajectoryBuilder.lineToConstantHeading(endPosition, velConstraint, accelConstraint, currentDecelConstraint));
    }

    public TrajectorySequenceBuilder lineToLinearHeading(Pose2d endPose) {
        return addPath(() -> currentTrajectoryBuilder.lineToLinearHeading(endPose, currentVelConstraint, currentAccelConstraint, currentDecelConstraint));
    }
    ...
    public TrajectorySequenceBuilder lineToLinearHeading(
        ...
        return addPath(() -> currentTrajectoryBuilder.lineToLinearHeading(endPose, velConstraint, accelConstraint, currentDecelConstraint));
    }
    ...
    public TrajectorySequenceBuilder lineToLinearHeading(
        ...
        return addPath(() -> currentTrajectoryBuilder.lineToLinearHeading(endPose, velConstraint, accelConstraint, decelConstraint));
    }

    public TrajectorySequenceBuilder lineToSplineHeading(Pose2d endPose) {
        return addPath(() -> currentTrajectoryBuilder.lineToSplineHeading(endPose, currentVelConstraint, currentAccelConstraint, currentDecelConstraint));
    }
    ...
    public TrajectorySequenceBuilder lineToSplineHeading(
        ...
        return addPath(() -> currentTrajectoryBuilder.lineToSplineHeading(endPose, velConstraint, accelConstraint, currentDecelConstraint));
    }
    ...
    public TrajectorySequenceBuilder lineToSplineHeading(
        ...
        return addPath(() -> currentTrajectoryBuilder.lineToSplineHeading(endPose, velConstraint, accelConstraint, decelConstraint));
    }

    public TrajectorySequenceBuilder strafeTo(Vector2d endPosition) {
        return addPath(() -> currentTrajectoryBuilder.strafeTo(endPosition, currentVelConstraint, currentAccelConstraint, currentDecelConstraint));
    }
    ...
    public TrajectorySequenceBuilder strafeTo(
        ...
        return addPath(() -> currentTrajectoryBuilder.strafeTo(endPosition, velConstraint, accelConstraint, currentDecelConstraint));
    }
    ...
    public TrajectorySequenceBuilder strafeTo(
        ...
        return addPath(() -> currentTrajectoryBuilder.strafeTo(endPosition, velConstraint, accelConstraint, decelConstraint));
    }

    public TrajectorySequenceBuilder forward(double distance) {
        return addPath(() -> currentTrajectoryBuilder.forward(distance, currentVelConstraint, currentAccelConstraint, currentDecelConstraint));
    }
    ...
    public TrajectorySequenceBuilder forward(
        ...
        return addPath(() -> currentTrajectoryBuilder.forward(distance, velConstraint, accelConstraint, currentDecelConstraint));
    }
    ...
    public TrajectorySequenceBuilder forward(
        ...
        return addPath(() -> currentTrajectoryBuilder.forward(distance, velConstraint, accelConstraint, decelConstraint));
    }

    public TrajectorySequenceBuilder back(double distance) {
        return addPath(() -> currentTrajectoryBuilder.back(distance, currentVelConstraint, currentAccelConstraint, currentDecelConstraint));
    }
    ...
    public TrajectorySequenceBuilder back(
        ...
        return addPath(() -> currentTrajectoryBuilder.back(distance, velConstraint, accelConstraint, currentDecelConstraint));
    }
    ...
    public TrajectorySequenceBuilder back(
        ...
        return addPath(() -> currentTrajectoryBuilder.back(distance, velConstraint, accelConstraint, decelConstraint));
    }

    public TrajectorySequenceBuilder strafeLeft(double distance) {
        return addPath(() -> currentTrajectoryBuilder.strafeLeft(distance, currentVelConstraint, currentAccelConstraint, currentDecelConstraint));
    }
    ...
    public TrajectorySequenceBuilder strafeLeft(
        ...
        return addPath(() -> currentTrajectoryBuilder.strafeLeft(distance, velConstraint, accelConstraint, currentDecelConstraint));
    }
    ...
    public TrajectorySequenceBuilder strafeLeft(
        ...
        return addPath(() -> currentTrajectoryBuilder.strafeLeft(distance, velConstraint, accelConstraint, decelConstraint));
    }

    public TrajectorySequenceBuilder strafeRight(double distance) {
        return addPath(() -> currentTrajectoryBuilder.strafeRight(distance, currentVelConstraint, currentAccelConstraint, currentDecelConstraint));
    }
    ...
    public TrajectorySequenceBuilder strafeRight(
        ...
        return addPath(() -> currentTrajectoryBuilder.strafeRight(distance, velConstraint, accelConstraint, currentDecelConstraint));
    }
    ...
    public TrajectorySequenceBuilder strafeRight(
        ...
        return addPath(() -> currentTrajectoryBuilder.strafeRight(distance, velConstraint, accelConstraint, decelConstraint));
    }

    public TrajectorySequenceBuilder splineTo(Vector2d endPosition, double endHeading) {
        return addPath(() -> currentTrajectoryBuilder.splineTo(endPosition, endHeading, currentVelConstraint, currentAccelConstraint, currentDecelConstraint));
    }
    ...
    public TrajectorySequenceBuilder splineTo(
        ...
        return addPath(() -> currentTrajectoryBuilder.splineTo(endPosition, endHeading, velConstraint, accelConstraint, currentDecelConstraint));
    }
    ...
    public TrajectorySequenceBuilder splineTo(
        ...
        return addPath(() -> currentTrajectoryBuilder.splineTo(endPosition, endHeading, velConstraint, accelConstraint, decelConstraint));
    }
    ...
    public TrajectorySequenceBuilder splineToConstantHeading(
        ...
        return addPath(() -> currentTrajectoryBuilder.splineToConstantHeading(endPosition, endHeading, velConstraint, accelConstraint, currentDecelConstraint));
    }
    ...
    public TrajectorySequenceBuilder splineToConstantHeading(
        ...
        return addPath(() -> currentTrajectoryBuilder.splineToConstantHeading(endPosition, endHeading, velConstraint, accelConstraint, decelConstraint));
    }

    public TrajectorySequenceBuilder splineToLinearHeading(Pose2d endPose, double endHeading) {
        return addPath(() -> currentTrajectoryBuilder.splineToLinearHeading(endPose, endHeading, currentVelConstraint, currentAccelConstraint, currentDecelConstraint));
    }
    ...
    public TrajectorySequenceBuilder splineToLinearHeading(
        ...
        return addPath(() -> currentTrajectoryBuilder.splineToLinearHeading(endPose, endHeading, velConstraint, accelConstraint, currentDecelConstraint));
    }
    ...
    public TrajectorySequenceBuilder splineToLinearHeading(
        ...
        return addPath(() -> currentTrajectoryBuilder.splineToLinearHeading(endPose, endHeading, velConstraint, accelConstraint, decelConstraint));
    }

    public TrajectorySequenceBuilder splineToSplineHeading(Pose2d endPose, double endHeading) {
        return addPath(() -> currentTrajectoryBuilder.splineToSplineHeading(endPose, endHeading, currentVelConstraint, currentAccelConstraint, currentDecelConstraint));
    }
    ...
    public TrajectorySequenceBuilder splineToSplineHeading(
        ...
        return addPath(() -> currentTrajectoryBuilder.splineToSplineHeading(endPose, endHeading, velConstraint, accelConstraint, currentDecelConstraint));
    }
    ...
    public TrajectorySequenceBuilder splineToSplineHeading(
        ...
        return addPath(() -> currentTrajectoryBuilder.splineToSplineHeading(endPose, endHeading, velConstraint, accelConstraint, decelConstraint));
    }
